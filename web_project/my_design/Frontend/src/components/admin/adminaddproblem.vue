<template>
  <el-form ref="addproblemform" :model="addproblemform" label-position="right" v-loading="loading">
    ...
    <el-form-item label="作者：">
      <el-input placeholder="必填" v-model="addproblemform.author" style="width:400px;"></el-input>
    </el-form-item>
    <el-form-item label="标题：">
      <el-input placeholder="题目标题，必填" v-model="addproblemform.title" style="width:400px;"></el-input>
    </el-form-item>
    <el-form-item label="介绍：">
      <el-input type="textarea" placeholder="必填"  v-model="addproblemform.des" autosize style="width:800px;"></el-input>
    </el-form-item>
    <el-form-item label="输入说明：">
      <el-input type="textarea" placeholder="必填" v-model="addproblemform.input" autosize style="width:800px;"></el-input>
    </el-form-item>
    <el-form-item label="输出说明：">
      <el-input type="textarea" placeholder="必填" v-model="addproblemform.output" autosize style="width:800px;"></el-input>
    </el-form-item>
    <el-form-item label="输入样例：">
      <el-input type="textarea" placeholder="1 1|#)2 2（多个样例间用 |#) 分割）" v-model="addproblemform.sinput" autosize style="width:800px;"></el-input>
    </el-form-item>
    <el-form-item label="输出样例：">
      <el-input type="textarea" placeholder="2|#)4（多个样例间用 |#) 分割）" v-model="addproblemform.soutput" autosize style="width:800px;"></el-input>
    </el-form-item>
    <el-form-item label="提示：">
      <el-input type="textarea" placeholder="必填" v-model="addproblemform.hint" autosize style="width:800px;"></el-input>
    </el-form-item>
...
export default {
  ...
  methods: {
    myupload(f) {
      ...
      let tail = f.file.name.split(".");

      if (tail[1] === "zip") {
        let newfile = new File([f.file], this.addproblemform.problem + ".zip");
      } else if (tail[1] === "jpg") {
        let newfile = new File([f.file], this.addproblemform.problem + ".jpg");
      }
    ...
    async handleSuccess(response, file, fileList) {
      ...
      try {
        let response = await this.$axios.post("/problem/", this.addproblemform);
      } catch (error) {
      ...
      let tag = this.addproblemdataform.tag.split("|");
