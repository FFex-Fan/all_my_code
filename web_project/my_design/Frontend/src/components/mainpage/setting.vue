  ...
  <el-card shadow="always" id="card">
    <el-form :model="form">
      ...
      <el-row :gutter="10" style="margin-top: 10px">
        <el-col :span="3">
          <div style="text-align:center;margin:5px;">描述</div>
        </el-col>
        <el-col :span="12">
    ...
    <el-button type="primary" @click="updateClick" style="float: right; margin-bottom: 10px; margin-right: 40px">更新</el-button>
  </el-card>
</template>
