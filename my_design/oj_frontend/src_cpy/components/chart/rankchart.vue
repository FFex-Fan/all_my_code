<template>
  <center>
    ...
    <h2></h2>
    <el-button size="mini" @click="seeall" type="primary">{{ label.seeall }}</el-button>
    <el-button style="margin-left:15px;" size="mini" @click="seeallblog" type="primary">{{ label.viewblog }}</el-button>
    <h2></h2>
