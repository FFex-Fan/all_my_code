  ...
  <div class="box">
    ...
    <div class="box_right">
      <el-row style="margin-top: 20px; margin-left: 20px;">
        ...
        <el-col :span="2">
          <el-button size="small" icon="el-icon-refresh-right" circle @click="code = ''"></el-button>
        </el-col>
...
export default {
  ...
  mounted() {
    ...
    // 设置codemirror高度
    that.editor.setSize('auto', this.clientHeight - 250);

    // 监听屏幕
    window.onresize = function () {
      that.clientHeight = `${document.documentElement.clientHeight}`;
      // 设置代码区域高度
      that.editor.setSize('auto', parseFloat(that.clientHeight) - 250);
    }
  },
  components: {
    codemirror,
