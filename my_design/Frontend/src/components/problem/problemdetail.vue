      ...
      <el-row>
        <el-card shadow="always">
          <el-row :gutter="18"
                  id="title">
            {{
              (this.oj === "MyOJ" ? "MyOJ" : "") + (this.oj === "MyOJ" ? " - " : "") + (this.oj === "MyOJ" ? this.proid : "") + ' '
            }}{{ title }}
          </el-row>
          <br>
          <el-row :gutter="18"
          ...
          <el-row :gutter="18"
            ...
            <el-row :gutter="18"
              ...
              <el-col :span="11"
                ...
                <el-row :gutter="18"
                        id="des"
                        style="margin-bottom: 0;">Sample Input {{ item }}
                  <el-button size="mini"
                ...
                <el-row :gutter="18"
                        id="data"
                        style="margin-bottom: 0px;">{{ sinput[index] }}
                </el-row>
              </el-col>
              <el-col :span="11"
                      id="text">
                <el-row :gutter="18"
                        id="des"
                        style="margin-bottom: 0px;">Sample Output {{ item }}
                </el-row>
                <el-row :gutter="18"
                        id="data"
                        style="margin-bottom: 0px;">{{ soutput[index] }}
                </el-row>
              </el-col>
            </el-row>
          </el-row>
